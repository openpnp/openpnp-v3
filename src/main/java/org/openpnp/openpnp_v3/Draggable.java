...
/**
 * Generalised implementation of 'Draggability' of a {@link Node}. The Draggable class is used
 * as a 'namespace' for the internal class/interfaces/enum.
...
public class Draggable {
     ...
     * <li>One or more DragNodes: that move in response to the drag events. The EventNode is
     * usually (but not always) a DragNode</li>
    ...
    public static final class Nature implements EventHandler<MouseEvent> {
        ...
        /**
         * When the initial mousePressed is missing we can supply the first coordinates
         * programmatically.
         * 
         * @param lastMouseX
         * @param lastMouseY
